          ...
          <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
            <form className="w-full">
              ...
              >
                ...
                <button
                  className="mt-1 w-full bg-teal-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-whitensition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                >
                  Sign Up
                </button>
              </div>
